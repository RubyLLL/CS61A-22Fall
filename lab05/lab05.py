...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    the_city = make_city('some_place', lat, lon)
    distance_1 = distance(the_city, city_a)
    distance_2 = distance(the_city, city_b)
    return get_name(city_a) if distance_1 < distance_2 else get_name(city_b)
