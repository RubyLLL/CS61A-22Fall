...
def play(strategy0, strategy1, update,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            score0 = update(num_dice0, score0, score1, dice)
        else:
            num_dice1 = strategy1(score1, score0)
            score1 = update(num_dice1, score1, score0, dice)
        who = 1 - who
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    for i in range(1,11):
        ...
        result = averaged_roll_dice(i, dice)
        if result > maximum:
            maximum = result
            num_roll = i
    return num_roll
...
def tail_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    return 0 if tail_points(opponent_score) >= threshold else num_rolls  # Remove this line once implemented.
    # END PROBLEM 10
